  ...
  return (
    <form onSubmit={handleSubmit} className="flex w-full flex-col gap-6 px-8">
      <div className="flex flex-col gap-1">
        ...
        <input
          type="text"
          placeholder="Digite o titulo do seu anúcio"
          id="title"
          className="rounded-full border border-gray-300 px-4 py-2 outline-0"
          value={title}
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="grow rounded-full border border-gray-300 px-4 py-2 outline-0"
            id="photos"
            value={photos}
      ...
      <div className="flex flex-col gap-1">
        ...
        <textarea
          type="text"
          placeholder="Digite a descrição do seu anúcio"
          id="description"
          className="h-56 resize-none rounded-2xl border border-gray-300 px-4 py-2 outline-0"
          value={description}
      ...
      <div className="flex flex-col gap-1">
        ...
        <textarea
          placeholder="Coloque aqui qualquer tipo de informação extra sobre seu anúcio"
          id="extras"
          className="h-56 resize-none rounded-2xl border border-gray-300 px-4 py-2 outline-0"
          value={extras}
      ...
      <div className="flex flex-col gap-1">
        <h2 className="ml-2 cursor-pointer text-2xl font-bold">
          Restrições e Preço
        </h2>
      ...
      <button className="hover:bg-primary-500 bg-primary-400 min-w-34 cursor-pointer rounded-full px-4 py-2 text-white transition ">
        Salvar Informações
      </button>
    </form>
  );
